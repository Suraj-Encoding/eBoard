...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center py-24">
      <h1 className="text-5xl text-purple-800 font-extrabold leading-tight sm:text-extra sm:text-4xl">
        Encoding-Board
      </h1>
      {/* <img className="w-30 h-50"  src="./logo.png" alt="logo" /> */}
      <h3 className="text-xl mt-4 sm:text-2xl">Real Time Digital Whiteboard</h3>
